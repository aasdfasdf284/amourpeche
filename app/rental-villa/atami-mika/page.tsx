export default function AtamiMika() {
  return (
        ...
        <div className="container-custom">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="bg-gradient-to-br from-amber-100 to-pink-100 h-96 rounded-2xl flex items-center justify-center">
                <div className="text-center">
                  <svg className="w-24 h-24 text-amber-600 mx-auto mb-4" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
                  </svg>
                  <p className="text-gray-600 text-lg">熱海ミカ邸の写真</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center p-6 bg-white rounded-2xl shadow-lg">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-2">海の絶景</h3>
                <p className="text-gray-600 text-sm">
                  テラスから熱海の美しい海を一望。朝日や夕日を楽しめる絶好のロケーションです。
                </p>
              </div>
              ...
              <div className="text-center p-6 bg-white rounded-2xl shadow-lg">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-2">温泉付き</h3>
                <p className="text-gray-600 text-sm">
                  熱海温泉を楽しめる温泉付き。心身を癒す贅沢な時間をお過ごしいただけます。
                </p>
              </div>
              ...
              <div className="text-center p-6 bg-white rounded-2xl shadow-lg">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-2">完全プライベート</h3>
                <p className="text-gray-600 text-sm">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-gradient-to-br from-amber-50 to-pink-50 p-8 rounded-2xl">
                ...
                <p className="text-3xl font-bold text-amber-600 mb-4">¥25,000</p>
              ...
              <div className="bg-gradient-to-br from-pink-50 to-amber-50 p-8 rounded-2xl border-2 border-pink-200">
                ...
                <p className="text-3xl font-bold text-pink-600 mb-4">¥35,000</p>
                <p className="text-gray-600 mb-6">1泊あたり</p>
                <ul className="text-gray-700 space-y-2 text-sm">
                  <li>• チェックイン 15:00</li>
                  <li>• チェックアウト 11:00</li>
              ...
              <div className="bg-gradient-to-br from-orange-50 to-amber-50 p-8 rounded-2xl">
                ...
                <p className="text-3xl font-bold text-orange-600 mb-4">¥20,000</p>
      ...
      <section className="py-20 bg-gradient-to-br from-amber-50 to-pink-50">
        <div className="container-custom text-center">
          ...
          <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto">
            熱海ミカ邸で、100歳まで元気に生きるための癒しの時間をお過ごしください。
          </p>
